...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $correctUsername = "KillianKaffa";
    $correctPassword = "1234567890";

    // Haal ingediende gegevens op
...
if ($ingevoerdeGebruikersnaam === $correctUsername && $ingevoerdWachtwoord === $correctPassword) {
    // Gebruiker is ingelogd, start een sessie
    session_start();
    $_SESSION['ingelogd'] = true; // Markeer de gebruiker als ingelogd
...
<body class="bg-gradient-to-r from-blue-400 to-purple-500 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-md shadow-md w-full max-w-md">
        <div class="flex items-center justify-center mb-4">
            <img src="../images/logo.png" alt="TwoHearts Logo" style="width: 50px;">
            <h2 class="text-2xl font-bold ml-2 text-gray-800">Inloggen</h2>
        </div>
        ...
        <form action="/login" method="post">
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" required
                    class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-purple-500 bg-gray-100">
            </div>
            ...
            <button type="submit"
                class="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white p-3 rounded-md hover:from-purple-600 hover:to-blue-600 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200">
                Inloggen
            </button>
        </form>

        <div class="mt-4 text-center">
            <p class="text-gray-700">Nog geen account? <a href="https://87249.stu.sd-lab.nl/twohearts/login/aanmeld.html" class="text-purple-500">Registreer hier.</a></p>
        </div>
    </div>
